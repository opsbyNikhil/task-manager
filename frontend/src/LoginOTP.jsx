...
function LoginOTP({ email, onLogin, onBack }) {
  ...
  const handleOTPChange = (event) => {
    ...
    // Allow digits only and maximum 6 digits
      ...
      <main className="login-main">
        ...
        <section className="login-intro">
          ...
          <p className="login-description">
            We have sent a one-time password to your email. Enter the code to
            securely access your TASKFLOW workspace.
          </p>
